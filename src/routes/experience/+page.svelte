  ...
  let items = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'ambev.com', url: 'https://ambev.com', iconComponent: OpenInNew },
      ],
      tecnologies: [
        'React',
        'Java',
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'seniorsistemas.com', url: 'https://seniorsistemas.com', iconComponent: OpenInNew },
      ],
      tecnologies: [
        'Angular',
        'Ionic',
      ...
      {#if item?.links?.length}
        <Row class="experience-content" justify="start">
          {#each item.links as link} 
            <Button class="experience-button" onClick={() => navigate(link.url)} link>
